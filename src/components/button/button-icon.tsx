	...
	],
	{
		...
		compoundVariants: [
			/* DEFAULT */
			{
				...
				color: "default",
				className:
					"bg-text-500 hover:bg-text-700 disabled:opacity-50 text-white disabled:hover:bg-text-500",
			},
			{
				variant: "outline",
				color: "default",
				className:
					"text-text-700 border-text-700 bg-white disabled:opacity-50",
			},
			{
				variant: "light",
				color: "default",
			...
			/* Primary */
			{
				variant: "solid",
				color: "primary",
				className: "bg-primary-100  disabled:opacity-50 text-primary-700",
			},
			{
				variant: "outline",
				color: "primary",
			...
			/* SECONDARY */
			{
				...
				color: "secondary",
				className:
					"bg-secondary-100  disabled:opacity-50 text-secondary-700",
			},
			{
				variant: "outline",
				color: "secondary",
			...
			/* NEUTRAL */
			{
				variant: "solid",
				color: "neutral",
				className: "bg-neutral-100  disabled:opacity-50 text-neutral-500",
			},
			{
				variant: "outline",
				color: "neutral",
				className:
					"text-neutral-500 border-neutral-500 bg-white hover:bg-neutral-500 hover:text-white disabled:hover:bg-white disabled:hover:text-neutral-500 disabled:opacity-50",
			},
			{
				variant: "light",
				color: "neutral",
				className:
					"text-neutral-500 hover:bg-neutral-100 disabled:hover:bg-white disabled:hover:text-neutral-500 disabled:opacity-50",
			},
			...
			/* SUCCESS */
			{
				variant: "solid",
				color: "success",
				className: "bg-success-100  disabled:opacity-50 text-success-700",
			},
			{
				variant: "outline",
				color: "success",
			...
			/* WARNING */
			{
				variant: "solid",
				color: "warning",
				className: "bg-warning-100 text-warning-700 disabled:opacity-50",
			},
			{
				variant: "outline",
				color: "warning",
				className:
					"text-warning-800 border-warning-700 bg-white hover:bg-warning-700 hover:text-white disabled:hover:bg-white disabled:hover:text-warning-800 disabled:opacity-50",
			},
			{
				variant: "light",
				color: "warning",
			...
			/* DANGER */
			{
				variant: "solid",
				color: "danger",
				className: "bg-danger-100 text-danger-700 disabled:opacity-50",
			},
			{
				variant: "outline",
				color: "danger",
